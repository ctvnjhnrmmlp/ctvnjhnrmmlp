const experiences = [
	...
	},
	{
		...
		mode: 'Remote',
		description: `Contributed to web product improvements using ReactJS, NextJS, TypeScript, and TailwindCSS while ensuring codebase maintainability. Led the team in enhancing user experience and overall functionality by leveraging modern tools to meet target requirements, fostering efficient team collaboration and problem-solving. Designed responsive and interactive interfaces with reusable components using React and integrated NextJS for improved performance and SEO.`,
